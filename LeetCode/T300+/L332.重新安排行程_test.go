...
func Test_findItinerary(t *testing.T) {
	//itinerary := findItinerary([][]string{{"MUC", "LHR"}, {"JFK", "MUC"}, {"SFO", "SJC"}, {"LHR", "SFO"}})
	//for _, v := range itinerary {
	//	t.Log(v)
	//}

	//itinerary := ]findItinerary([][]string{{"JFK", "SFO"}, {"JFK", "ATL"}, {"SFO", "ATL"}, {"ATL", "JFK"}, {"ATL", "SFO"}})
	//for _, v := range itinerary {
	//	t.Log(v)
	//}

	//itinerary := findItinerary([][]string{
	//	{"EZE", "AXA"},
	//	{"TIA", "ANU"},
	//	{"ANU", "JFK"},
	//	{"JFK", "ANU"},
