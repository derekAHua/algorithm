...
func Test_minSubArrayLen(t *testing.T) {
	...
	tests := []struct {
		...
		{"t3", args{target: 11, nums: []int{1, 2, 3, 4, 5}}, 3},
	}
...
func Test_minSubArrayLenRepeat2(t *testing.T) {
	type args struct {
		target int
		nums   []int
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if gotRet := minSubArrayLenRepeat2(tt.args.target, tt.args.nums); gotRet != tt.wantRet {
				t.Errorf("minSubArrayLenRepeat2() = %v, want %v", gotRet, tt.wantRet)
			}
		})
	}
}

func Test_minSubArrayLenRepeat3(t *testing.T) {
	type args struct {
		target int
		nums   []int
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if gotRet := minSubArrayLenRepeat3(tt.args.target, tt.args.nums); gotRet != tt.wantRet {
				t.Errorf("minSubArrayLenRepeat2() = %v, want %v", gotRet, tt.wantRet)
			}
		})
	}
